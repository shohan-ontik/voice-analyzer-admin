...
export function HelpCircleIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M9.5 9a2.5 2.5 0 0 1 4.9.75c0 1.5-2.15 1.85-2.4 3" />
...
export function ClipboardClockIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <rect x="8" y="2" width="8" height="4" rx="1" />
      <path d="M9 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h5.5" />
...
export function UploadCloudIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M20 16.6A5 5 0 0 0 18 7h-1.3A7 7 0 1 0 4 14.2" />
